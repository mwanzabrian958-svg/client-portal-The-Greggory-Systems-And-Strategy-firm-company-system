...
object RetrofitClient {
    ...
    const val BASE_URL = "https://greggory-firm-rtl3.onrender.com/"
    ...
    private val certificatePinner = if (!com.greggory.portal.BuildConfig.DEBUG) {
        okhttp3.CertificatePinner.Builder()
            .add("greggory-firm-rtl3.onrender.com", "sha256/fizfE9JVlzlRplEx7epXfqW9enrbLvwF/LU26XTPEG4=")
            .add("greggory-firm-rtl3.onrender.com", "sha256/8emdl/UmneUm0I4Y/vHzOTQzb9eJwG4voRHtMdNmBPk=")
            .add("greggory-firm-rtl3.onrender.com", "sha256/kIdp6NNEd8wsugYyyIYFsi1ylMCED3hZbSR8ZFsa/A4=")
            .add("greggory-firm-rtl3.onrender.com", "sha256/mEflZT5enoR1FuXLgYYGqnVEoZvmf9c2bVBpiOjYQ0c=")
            .build()
    } else {
